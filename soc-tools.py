...
def parse_vt_details(vt_response):
    """Extrai métricas avançadas de reputação para o analista de SOC."""
    ...
    try:
        ...
        tags = attrs.get("tags", [])[:3] # Pega até 3 tags principais
            ...
            if ips:
                ...
                st.dataframe(
                    ...
                    column_config={
                        ...
                        "Link AbuseIPDB": st.column_config.LinkColumn(
                            "Link AbuseIPDB",
