...
Uso indevido da aplicação; Consultas realizadas sem autorização; Violação de legislação, contratos ou políticas internas; Danos decorrentes da interpretação ou utilização dos resultados; Tratamento irregular de dados pessoais; Ações realizadas pelo usuário com base nas informações apresentadas pela ferramenta. 📌 Princípio de uso
...
🛡️ Cyber Threat Research - Caçador de Ameaças V3.9 Aplicação web desenvolvida em Streamlit para automação de Threat Hunting, Detection Engineering e Triagem de IOCs (Indicadores de Comprometimento).
