...
with tab_hypotheses:
    ...
    # Base de Dados Pré-Cadastrada de Hipóteses Técnicas
    if "hypotheses_db" not in st.session_state:
        st.session_state["hypotheses_db"] = [
            ...
            },
            {
                ...
                "tech_id_link": "https://attack.mitre.org/techniques/T1003/001/",
    ...
    # Métrica Rápida do Painel de Caça
    ...
    # Seção 1: Formulário para Criar Nova Hipótese
    ...
    # Seção 2: Tabela de Gerenciamento das Hipóteses
    st.subheader("📋 Matriz Operacional de Hipóteses")
    
    # Exibição resumida em DataFrame
    ...
    # Seção 3: Detalhamento Técnico e Execução de Testes
