...
# --- XposedOrNot Analytics (Com datas e detalhes completos) ---
...
# =============================================================================
# ABA 8: CONSULTA DE VAZAMENTOS (XPOSEDORNOT - FREE)
# =============================================================================
with tab_xposed:
        ...
        if target_email:
            with st.spinner("Consultando base de dados do XposedOrNot..."):
                ...
                if "error" in res:
                    ...
                    summary = res.get("BreachesSummary", {})
                    ...
                    if total_breaches > 0:
                        ...
                        for b in breaches_list:
                            ...
                            # Formatação da Data do Vazamento
