...
st.markdown("""
    <style>
        ...
        :root {
            ...
            --cyber-border-hover: rgba(0, 242, 254, 0.6);
            --cyber-text: #cbd5e1;
            --cyber-text-dim: #64748b;
            --cyber-text-bright: #e2e8f0;
        ...
        /* ============ QUICK-ACCESS HUB - TOOL CARDS/BUTTONS ============ */
        .tool-grid {
            display: grid;
...
# -----------------------------------------------------------------------------
# 5. QUICK-ACCESS THREAT INTEL HUB (V3.8 - MELHORADO)
# -----------------------------------------------------------------------------
...
def render_osint_unified_report(query_value, query_kind, results):
    ...
    # Status das fontes com indicadores visuais
...
with tab_urlscan:
    ...
    # Sub-abas para organizar as funcionalidades
        ...
        if not gn_ip:
            ...
            with st.spinner("Consultando GreyNoise..."):
                ...
                if "error" in gn_res:
                    ...
                    # Evitar duplicados no histórico
                    st.session_state["greynoise_history"] = [
...
with tab_osint:
    ...
    # Layout melhorado com indicador visual do tipo detectado
